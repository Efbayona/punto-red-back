...
public interface RechargeRepository extends JpaRepository<Recharge, UUID> {
    @Query("Select new com.project.punto_red.recharge.dto.RechargeHistoryResponse(r.message, r.cellPhone , r.value, r.transactionalID, r.supplierId, r.createdAt) from Recharge r order by r.createdAt desc ")
