...
public class Recharge extends AuditEntity {
    ...
    public Recharge(String message, UUID transactionalID, String cellPhone, Double value) {
    ...
    public static Recharge create(String message, UUID transactionalID, String cellPhone, Double value) {
        return new Recharge(message, transactionalID, cellPhone, value );
    }
